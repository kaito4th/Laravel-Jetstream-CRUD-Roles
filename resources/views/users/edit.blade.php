                ...
                <form method="post" action="{{ route('users.update', $user->user_id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="number" id="number" value="{{ old('number', $user->number) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                            @error('number')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="daily_rate" id="daily_rate" value="{{ old('daily_rate', $user->daily_rate) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                            @error('daily_rate')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
